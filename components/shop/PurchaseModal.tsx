    ...
    >
      <div className="transparent-bg relative w-full max-w-sm mx-4 rounded-sm border border-white/20 p-lg">
        ...
        <div className="text-center">
          ...
          <p className="text-white/40 text-sm mb-1">{item.description}</p>
          <p className="text-amber-400/80 text-xs mb-md">
            (These are placeholders - they do nothing yet - Im too lazy to make
            a branch so I be pushing to main - so buy if you want idc bro)
          </p>
          ...
          {state === "waiting" && (
            <div className="py-md">
              ...
              <p className="text-white/30 text-xs mt-xs">
                Accept the request from StackCoin on Discord
              </p>
            </div>
          )}
          ...
          {state === "success" && (
            <div className="py-md">
              ...
              <Button variant="primary" className="mt-md" onClick={onClose}>
                Done
              </Button>
            </div>
          )}
          ...
          {(state === "denied" || state === "timeout") && (
            <div className="py-md">
              ...
              <Button variant="secondary" className="mt-md" onClick={onClose}>
                Close
              </Button>
            </div>
          )}
